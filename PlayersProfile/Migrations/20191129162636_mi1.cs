...
namespace PlayersProfile.Migrations
{
    public partial class mi1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_playerstab", x => x.PlayerID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_carstab", x => x.CarID);
                    table.ForeignKey(
                        name: "FK_carstab_playerstab",
                        column: x => x.PlayerID,
                        principalTable: "playerstab",
